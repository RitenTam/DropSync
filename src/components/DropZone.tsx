      ...
      <div
        ...
        className={`relative overflow-hidden rounded-2xl border p-6 md:p-8 text-center cursor-pointer transition-all duration-300 ${
          isDragging
            ...
            : "border-primary/30 bg-[#0d1010] hover:border-primary/50 lift-hover"
        }`}
      >
        ...
        <AnimatePresence mode="wait">
          {droppedFiles.length > 0 ? (
            ...
            >
              <div className="mx-auto flex w-fit items-center gap-3 rounded-xl border border-border/70 bg-[#101312] px-4 py-2 shadow-sm">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                <button
                  ...
                  className="rounded-lg border border-border/70 bg-[#101312] px-3 py-2 text-xs font-semibold text-foreground shadow-sm transition-colors hover:bg-secondary"
                >
                  Add files
                </button>
                <button
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-border/70 bg-[#101312] px-3 py-2 text-xs font-semibold text-foreground shadow-sm transition-colors hover:bg-secondary"
                >
